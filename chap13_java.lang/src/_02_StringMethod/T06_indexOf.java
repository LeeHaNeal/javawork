...
// lastindexOf(char, fromIndex) : fromIndex번호부터앞으로 가면서 글자가 있나 확인후 index번호 반환
// lastindexOf(String) : 문자열의 시작 index번호 반환
...
public class T06_indexOf {
	...
	public static void main(String[] args) {
		...
		System.out.println("5번 index이후에 나오는 a의 index번호 : " + index);
		...
		System.out.println("va의 index 번호 : " + index);

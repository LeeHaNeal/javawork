...
// replaceAll(기존문자 , 바꿀문자) : 기존문자를 바꿀 문자로 바꾸기 (정규표현식 때)
// replaceFirst(기존문자 , 바꿀문자) : 맨처음 나오는 문자를 

public class T07_replace {

	public static void main(String[] args) {
		
		String str = "javaprogrammin java awsjava dajava";
		
		String reStr = str.replace("m", "j");

...
class Apple2{int num = 10; }
class Banana2{ boolean bool = true;}
...
public class T02_Generic {
	...
	public static void main(String[] args) {
		...
		box.set("홍길동");
		String str = box.get();
		System.out.println(str); // String클래스는 toString을 오버라이딩 해놓은 상태이다.
		
		Box2 <Apple2> apple = new Box2();
		apple.set(new Apple2());
		Apple2 aple = apple.get();
		System.out.println(aple.num);

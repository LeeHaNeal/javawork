...
public class T01_Math {
	...
	public static void main(String[] args) {
		// 절대값 : abs
		System.out.println("-15의 절대 값: " + Math.abs(-15));
		System.out.println("-15.6789의 절대 값 : " + Math.abs(-15.6789));
		System.out.println("-----------------------");
		// 소수점이하 무조건 올림 : ceil();
		...
		System.out.println("12.34567을 소수점 2째 자리까지"+Math.round(value2)/100.0);
		System.out.println("-----------------------");
		
						
		
		// 두 수중 큰수 or 작은수 : Max() , Min()
		System.out.println("7과 5중 큰 수 : " + Math.max(7, 5));
		System.out.println("7과 5중 작은 수 : " + Math.min(7, 5));
		...
		System.out.println("80의 제곱근 : " + (int)Math.sqrt(80));

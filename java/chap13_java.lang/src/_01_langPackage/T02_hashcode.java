...
/*
	Object클래스에 있는 hashCode()는 객체의 주소로 해시코드를 만든다
...
public class T02_hashcode {
	...
	public static void main(String[] args) {
		...
		System.out.println("e1의 고유한 해시코드 : "+e1.hashCode());
		System.out.println("e2의 고유한 해시코드 : "+e2.hashCode());
		...
		// String클래스에서 hashCode()를 오버라이딩한 상태

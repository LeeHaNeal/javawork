...
public class T01_api_method {
	...
	// 1. 반환형이 없는 메소드
	//  void 메소드명() { 실행할 구문 } 
	// * 객체를 만들어 메소드를 호출했을 때 변수에 저장할 수 없음
	// * 객체를 만들어 메소드를 호출했을 때 출력문안에 넣을 수 없음
	int num1 =5;
	...
	String print3( ) {
		System.out.println("반환값이 String이고 매개변수도 없는 메소드");
		return "반환되는 문자";
	}
	
	boolean print4() {
		System.out.println("반환값이 boolean이고 매개변수도 없는 메소드");
		return true;
	}
	...
	void print5(int x) {
		System.out.println("반환형이 없고 매개변수가 1개 인 메소드");
